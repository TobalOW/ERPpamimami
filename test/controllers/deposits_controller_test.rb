...
class DepositsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create deposit" do
    assert_difference('Deposit.count') do
      post deposits_url, params: { deposit: { method: @deposit.method, order_id: @deposit.order_id, total: @deposit.total } }
    end
  ...
  test "should update deposit" do
    patch deposit_url(@deposit), params: { deposit: { method: @deposit.method, order_id: @deposit.order_id, total: @deposit.total } }
