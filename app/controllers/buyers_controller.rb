class BuyersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @buyer.save
        format.html { redirect_to action: :index, notice: 'Buyer was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @buyer.update(buyer_params)
        format.html { redirect_to action: :index, notice: 'Buyer was successfully updated.' }
  ...
  private
    ...
    def buyer_params
      params.require(:buyer).permit(:name, :rut)
    end
end
